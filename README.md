...
| 1️⃣ Fork 本仓库 | 截图下你github账户头像和该仓库 | ![cut]() |
| 2️⃣ Clone 到本地 | 下载代码，准备改文件 | ![clone]() |
| 3️⃣ 新建分支 | 分支名格式 `add-名字拼音` | ![branch]() |
| 4️⃣ 写简历并提交 | 按模板或自定义写 `你的名字拼音.md`，`git push` | ![commit]() |
| 5️⃣ 发起 Pull Request | 填写 PR 标题+自述，等待合并 | ![pr]() |
